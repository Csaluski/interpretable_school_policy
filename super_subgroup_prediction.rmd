...
# "below.basic.pct.total", "below.basic.pct.iep", "prof.and.adv.pct.gap", "year"
)

exclude.avg.cols <- c("CFA_avg", "PD_avg", "DBDM_avg", "Leadership_avg")

exclude.col.set.list <- list("standard" = exclude.cols, "avgs" = c(exclude.cols, exclude.avg.cols))
...
png(filename = "./img_out/iep_ela.loss.mse.png", width = 6, height = 60, unit = "in", res = 200)
print(err.plot)
dev.off()
