...
png(filename = "./img_out/regr.loss.mse.all.png", width = 6, height = 6, unit = "in", res = 200)
print(err.plot)
dev.off()
...
png(filename = "./img_out/regr.loss.mse.both.png", width = 6, height = 4, unit = "in", res = 200)
print(err.plot)
dev.off()
...
png(filename = "./img_out/regr.loss.mse.etlp.png", width = 6, height = 4, unit = "in", res = 200)
print(err.plot)
dev.off()
```
...
for (method.select in glm.method.v) {
  for (task.name in task.name.vec) {
    ...
    filename <- paste("img_out/",method.select, task.name, ".png", sep = "")
    print(filename)
