...
task.name.vec <- c("etlp", "etlp.no.cfa", "cfa")

task.list <- list(task.full.regr, task.no.cfa.regr, task.cfa.regr)
...
ctree.var.dt <- ctree.dt[, {
  # TODO get 0 counts by using factor with vector of levels, from original tasks
